                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-611px, 0px, 0px); transition: all 3s ease 0s; width: 2446px;"><div class="owl-item active" style="width: 581.5px; margin-right: 30px;"><div class="items">
